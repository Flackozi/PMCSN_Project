...
def execute(stats, stop):
    ...
    if stats.t.current == stats.t.arrival: 
        ...
        if job["classe"] == 1:
            ...
            jid = stats.next_job_id  
            stats.next_job_id  += 1 
            stats.P_jobs[jid] = {"rem": get_service_P()} #aggiungo il job a P
            stats.index_A2 += 1
            ...
            stats.index_A3 += 1
            # stats.job_times[jid]["departure"] = stats.t.current  # salvo il tempo di completamento del job
